...
#ifndef MOTION_KINECT_HPP_
#define MOTION_KINECT_HPP_
...
#include <motion_kinect/user_IDs.h>
#include <motion_kinect/user_points.h>
#include <motion_kinect/bounding_box.h>
...
/**
 * Class \ref motion_kinect. This class can track the skeleton of people and returns joints as a TF stream,
 */
class k2_tracker
{
public:
      ...
      it_(nh_)
  {
    ...
    userPub_ = nh_.advertise<motion_kinect::user_IDs>("/people_skeleton", 1);
    pointPub_ = nh_.advertise<motion_kinect::user_points>("/people_points", 1);
...
//	   calibrationOriginVec3 = calibrationOriginVec3 * 20;
  ...
  */
  void getSkeleton()
  {
    ...
    motion_kinect::user_IDs ids;
    motion_kinect::user_points points;
...
//publishes the funny normal vector from the users chest
      ...
      if(user.isVisible()){
        ...
        motion_kinect::bounding_box bbox;
